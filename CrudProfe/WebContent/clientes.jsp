			...
			<div class="col-12">
				...
				<p>
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target="#modalCliente" onClick="document.forms[0].reset()">Añadir
						cliente</button>
				</p>
				<p>Buscar: 
				<input type="text" name="buscanombre" id="buscanombre">
				<span onClick="buscarCliente()">
					...
					<tbody id="cuerpoTabla">
						<c:forEach var="cliente" items="${clientes}">
							<tr id="cliente${cliente.id}" data-id="${cliente.id}"
								...
								<td><span onClick="mostrarCliente(${cliente.id})"> <i
										class="fas fa-user-edit"></i></span></td>
								<td><span onClick="eliminarCliente(${cliente.id})"
									style="color: red"> <i class="fas fa-user-times"></i></span></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">Datos del
						cliente</h5>
				...
				<div class="modal-body">
					<form id="formCliente" name="formCliente">
						...
						<input type="button" id="btnEnviar" class="btn btn-primary"
							onClick="enviarCliente()" value="Enviar cliente">
					</form>
				</div>
...
function buscarCliente(){
	window.location.href="/CrudProfe/clientes?operacion=buscar&nombre=" + document.getElementById('buscanombre').value;
}
